      ...
      <div class="bg-white rounded-2xl shadow-md p-8 md:p-12 border border-gray-100">
        <div class="prose prose-sm sm:prose-base max-w-none text-gray-700">
          ...
          <section class="mb-8">
            ...
            <p>
              Bienvenue sur Coachiles. Nous accordons une grande importance à la protection de vos données personnelles. 
            ...
            <p>
              Coachiles est une plateforme de mise en relation entre coachs sportifs et personnes recherchant 
              un accompagnement personnalisé aux Antilles.
            </p>
          </section>
          ...
          <section class="mb-8">
            ...
            <h3 class="text-lg font-semibold text-gray-800 mt-4 mb-2">2.1 Données d'identification</h3>
            <ul>
              <li>Nom et prénom</li>
              <li>Adresse email</li>
            ...
            <h3 class="text-lg font-semibold text-gray-800 mt-4 mb-2">2.2 Données de profil coach</h3>
            <ul>
              <li>Spécialités et compétences</li>
            ...
            <h3 class="text-lg font-semibold text-gray-800 mt-4 mb-2">2.3 Données de navigation</h3>
            <ul>
              <li>Adresse IP</li>
            ...
            <h3 class="text-lg font-semibold text-gray-800 mt-4 mb-2">2.4 Données de paiement</h3>
            <ul>
          ...
          <section class="mb-8">
            ...
            <ul>
              ...
              <li>Permettre la mise en relation entre coachs et clients</li>
          ...
          <section class="mb-8">
            <h2 class="text-2xl font-bold text-gray-900 mb-4">4. Base Légale du Traitement</h2>
          ...
          <section class="mb-8">
            ...
            <p>
              Ces partenaires sont soumis à des obligations contractuelles strictes de confidentialité 
          ...
          <section class="mb-8">
            ...
            <ul>
              ...
              <li><strong>Demandes de leads :</strong> 2 ans après la dernière interaction</li>
            </ul>
          </section>
          ...
          <section class="mb-8">
            ...
            <ul>
              ...
              <li>Contrôle d'accès par rôles (RLS)</li>
          ...
          <section class="mb-8">
            ...
            <p>
              ...
              <a href="mailto:privacy@coachiles.com" class="text-orange-600 hover:underline">privacy@coachiles.com</a>
            </p>
          </section>
          ...
          <section class="mb-8">
            ...
            <ul>
              <li><strong>Cookies essentiels :</strong> fonctionnement du site et authentification</li>
          ...
          <section class="mb-8">
            ...
            <p>
              Vos données peuvent être transférées vers des serveurs situés hors de l'Union Européenne 
              (notamment aux États-Unis via nos prestataires). Ces transferts sont encadrés par des 
              clauses contractuelles types approuvées par la Commission Européenne.
            </p>
          </section>

          <section class="mb-8">
            <h2 class="text-2xl font-bold text-gray-900 mb-4">11. Mineurs</h2>
            <p>
              Coachiles n'est pas destiné aux personnes de moins de 16 ans. Nous ne collectons pas 
          ...
          <section class="mb-8">
            <h2 class="text-2xl font-bold text-gray-900 mb-4">12. Modifications</h2>
            <p>
              Nous pouvons modifier cette politique de confidentialité à tout moment. Les modifications 
              seront publiées sur cette page avec une nouvelle date de mise à jour. En cas de modifications 
              substantielles, nous vous en informerons par email.
            </p>
          </section>
          ...
          <section class="mb-8">
            ...
            <ul>
              <li><strong>Email :</strong> <a href="mailto:privacy@coachiles.com" class="text-orange-600 hover:underline">privacy@coachiles.com</a></li>
            ...
            <p>
              ...
              de l'Informatique et des Libertés) : <a href="https://www.cnil.fr" target="_blank" class="text-orange-600 hover:underline">www.cnil.fr</a>
            </p>
          </section>
