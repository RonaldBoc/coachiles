    ...
    <header class="bg-white border-b">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
        <div class="flex items-center justify-between">
          <div>
            <h1 class="text-2xl font-semibold text-gray-900">Superadmin</h1>
            <p class="mt-1 text-sm text-gray-500">Platform overview and administration</p>
          </div>
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          ...
          >
            <div class="px-4 py-5 sm:p-6">
              ...
              <dd class="mt-1 text-2xl font-semibold text-gray-900">{{ card.value }}</dd>
            </div>
          </div>
        </div>
        <div class="bg-white rounded-lg shadow">
          <div class="px-4 py-5 sm:p-6">
            <h3 class="text-base font-semibold text-gray-900">Recent deletion requests</h3>
              ...
              <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  <tr v-for="log in deletionLogs.slice(0, 5)" :key="log.id">
                    <td class="px-3 py-2 text-sm text-gray-900">{{ log.coach_name || '—' }}</td>
            ...
            <table class="min-w-full divide-y divide-gray-200">
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                <tr v-for="c in filteredCoaches" :key="c.id">
                  ...
                  <td class="px-3 py-2 text-sm text-gray-500">{{ c.subscription_type || '—' }}</td>
            ...
            <table class="min-w-full divide-y divide-gray-200">
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                <tr v-for="l in leads" :key="l.id">
                  <td class="px-3 py-2 text-sm text-gray-900">{{ l.client_name }}</td>
